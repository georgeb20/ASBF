...
// xxd -i person_detect.tflite > squirrel_detect_model_data.cc
...
extern const unsigned char g_squirrel_detect_model_data[];
extern const int g_squirrel_detect_model_data_len;
